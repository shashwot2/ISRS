...
import { View, Text, ScrollView, TouchableOpacity, StyleSheet, Image, ViewStyle, TextStyle, ImageStyle, Platform } from 'react-native';
import { useLanguageLearning } from './languagecontext';
import { Brain, Clock, Target, Lightbulb, Zap, BarChart2, Settings, Calendar, ChevronRight, TrendingUp, BookOpen, Repeat } from 'lucide-react';
...
type Styles = {
  ...
  memoryMetric: ViewStyle;
  memoryInfo: ViewStyle;
  memoryTitle: TextStyle;
  memoryValue: TextStyle;
...
// FAKE DATA FOR NOW till we get the real data from Firebase and AI
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.profileInfo}>
          ...
          <Text style={styles.username}>Your Mom</Text>
          <Text style={styles.userLevel}>Intermediate • {selectedLanguage}</Text>
        </View>
      </View>
          ...
          <View key={index} style={styles.memoryCard}>
            <View style={styles.cardHeader}>
              ...
              <View style={styles.memoryInfo}>
                ...
                <Text style={styles.memoryDescription}>{metric.description}</Text>
              </View>
            </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.learningInsights}>
          <View style={styles.insightCard}>
            ...
            <Text style={styles.insightValue}>{learningStats.averageRecallTime}s</Text>
          </View>
          <View style={styles.insightCard}>
            <View style={styles.insightHeader}>
            ...
            <Text style={styles.insightValue}>+{learningStats.vocabularyGrowth}/day</Text>
          </View>
        </View>
      </View>
